    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-2xl font-bold text-gray-900">Welcome back, {{ auth()->user()->first_name }}! 👋</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <a href="#" class="text-indigo-600 text-sm font-medium mt-4 inline-block hover:text-indigo-700">View all orders →</a>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <a href="#" class="text-pink-600 text-sm font-medium mt-4 inline-block hover:text-pink-700">View inspirations →</a>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <a href="#" class="text-green-600 text-sm font-medium mt-4 inline-block hover:text-green-700">Go to cart →</a>
                </div>
            </div>
